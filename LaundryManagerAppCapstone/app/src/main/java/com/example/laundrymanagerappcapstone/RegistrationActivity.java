...
public class RegistrationActivity extends AppCompatActivity {
    ...
    private void createHero() {
        ...
        com.example.laundrymanagerappcapstone.RegistrationActivity.PerformNetworkRequest request = new com.example.laundrymanagerappcapstone.RegistrationActivity.PerformNetworkRequest(Api.URL_CREATE_STORE_MANAGER, params, CODE_POST_REQUEST);
        request.execute();
    }
...
*/
    ...
    private void refreshHeroList(JSONArray managers) throws JSONException {
        ...
        com.example.laundrymanagerappcapstone.RegistrationActivity.ManagerAdapter adapter = new com.example.laundrymanagerappcapstone.RegistrationActivity.ManagerAdapter(managerList);
    ...
    class ManagerAdapter extends ArrayAdapter<com.example.laundrymanagerappcapstone.apiconnection.Manager> {
        ...
        public ManagerAdapter(List<com.example.laundrymanagerappcapstone.apiconnection.Manager> managerList) {
            super(com.example.laundrymanagerappcapstone.RegistrationActivity.this, R.layout.layout_store_manager_list, managerList);
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            textViewDelete.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    AlertDialog.Builder builder = new AlertDialog.Builder(com.example.laundrymanagerappcapstone.RegistrationActivity.this);
